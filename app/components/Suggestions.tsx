  ...
  return (
    <div className="px-4 pb-2">
      <div className="flex justify-between items-center mb-2">
        <p className="text-sm font-medium text-gray-600">你可以这样问</p>
        <button className="p-1 hover:bg-gray-200 rounded-full" aria-label="Refresh suggestions"><RefreshIcon/></button>
      </div>
